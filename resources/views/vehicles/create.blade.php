...
@section('content')
<h5 class="page-title mb-3">{{ __('Tambah Kendaraan Baru') }}</h5>
...
@if ($errors->any())
    <div class="alert alert-danger alert-dismissible fade show rounded-4 shadow-sm mb-4 border-0" role="alert" style="border-left: 5px solid #dc3545 !important;">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <h6 class="fw-bold mb-1 text-danger">{{ __('Gagal Menyimpan Kendaraan:') }}</h6>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('vehicles.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">{{ __('Jenis Kendaraan') }}</label>
                ...
                <div class="col-md-6">
                    <label class="form-label">{{ __('Tahun Pembuatan') }}</label>
                ...
                <div class="col-md-6">
                    <label class="form-label">{{ __('Lokasi Pool') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('Pajak Tahunan (Rp)') }}</label>
                ...
                <div class="col-md-6">
                    <label class="form-label">{{ __('Jadwal Servis Berikutnya (Manual)') }}</label>
            ...
            <div class="mt-4 form-actions-mobile">
                <button class="btn btn-brand">{{ __('Simpan') }}</button>
                <a href="{{ route('vehicles.index') }}" class="btn btn-secondary">{{ __('Batal') }}</a>
            </div>
        </form>
    </div>
</div>
