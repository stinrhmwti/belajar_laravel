@extends('layouts.app')
@section('title', __('Tambah Riwayat Servis'))
...
<div class="card border-0 shadow-sm rounded-4 bg-white" style="border-radius: 16px;">
    <div class="card-header bg-white py-3 border-bottom">
        <h5 class="fw-bold text-dark mb-0"><i class="bi bi-clock-history text-primary me-1"></i> {{ __('Tambah Riwayat Servis') }}</h5>
    </div>
        ...
        <form action="{{ route('vehicle-histories.store') }}" method="POST">
            ...
            <div class="mt-4 d-flex gap-2">
                <button type="submit" class="btn btn-primary px-4 py-2" style="border-radius: 8px; font-weight: 600; font-size: 0.88rem;">
                    <i class="bi bi-save"></i> {{ __('Simpan Riwayat') }}
                </button>
