...
<div class="container mt-4 mb-5">
    ...
    <div class="card border-0 shadow">
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('guru.update-soal', $soal->id) }}">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kategori_id" class="form-select" required>
                            ...
                            <option value="{{ $kat->id }}" {{ $soal->kategori_id == $kat->id ? 'selected' : '' }}>
                                {{ $kat->nama_kategori ?? 'Kategori '.$kat->id }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="pilihan_a" class="form-control" value="{{ $soal->pilihan_a }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-bold">Pilihan B</label>
                        <input type="text" name="pilihan_b" class="form-control" value="{{ $soal->pilihan_b }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="fw-bold">Pilihan C</label>
                        <input type="text" name="pilihan_c" class="form-control" value="{{ $soal->pilihan_c }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-bold">Pilihan D</label>
                        <input type="text" name="pilihan_d" class="form-control" value="{{ $soal->pilihan_d }}" required>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <select name="kunci_jawaban" class="form-select" required>
                        ...
                        <option value="{{ $huruf }}" {{ $soal->kunci_jawaban == $huruf ? 'selected' : '' }}>
                            {{ strtoupper($huruf) }}
                        </option>
                        @endforeach
                    </select>
